const AssistantProxyService = require('../services/assistantProxy');

function setupAssistantHandlers(ipcMain, databaseService) {
...
// Import getCurrentUserId from auth handler
